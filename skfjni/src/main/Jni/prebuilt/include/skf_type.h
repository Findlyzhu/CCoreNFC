...
typedef struct SKF_ENVELOPEDKEYBLOB{
	u32 Version;					// ��ǰ�汾Ϊ 1
	u32 ulSymmAlgID;				// �Գ��㷨��ʶ���޶�ECBģʽ
	u32 ulBits;						// ������Կ�Ե���Կλ����
	u8  cbEncryptedPriKey[64];		// ������Կ��˽Կ������
...
#define SGD_SSF33_ECB       0x00000201       //SSF33 �㷨 ECB ����ģʽ 
#define SGD_SSF33_CBC       0x00000202       //SSF33 �㷨 CBC ����ģʽ 
#define SGD_SSF33_CFB       0x00000204       //SSF33 �㷨 CFB ����ģʽ 
#define SGD_SSF33_OFB       0x00000208       //SSF33 �㷨 OFB ����ģʽ 
#define SGD_SSF33_MAC       0x00000210       //SSF33 �㷨 MAC ���� 
...
////////////////////////////VENDOR DEFINED/////////////////////////////////////
#define SGD_DES_ECB			0x80000101       //DES �㷨 ECB ����ģʽ 
#define SGD_DES_CBC			0x80000102       //DES �㷨 CBC ����ģʽ 
#define SGD_DES_CFB			0x80000104       //DES �㷨 CFB ����ģʽ 
#define SGD_DES_OFB			0x80000108       //DES �㷨 OFB ����ģʽ 
#define SGD_DES_MAC			0x80000110       //DES �㷨 MAC ���� 

#define SGD_AES_ECB			0x80000201       //AES �㷨 ECB ����ģʽ 
#define SGD_AES_CBC			0x80000202       //AES �㷨 CBC ����ģʽ 
#define SGD_AES_CFB			0x80000204       //AES �㷨 CFB ����ģʽ 
#define SGD_AES_OFB			0x80000208       //AES �㷨 OFB ����ģʽ 
#define SGD_AES_MAC			0x80000210       //AES �㷨 MAC ���� 

#define SGD_SM6_ECB			0x80000301       //SM6 �㷨 ECB ����ģʽ 
#define SGD_SM6_CBC			0x80000302       //SM6 �㷨 CBC ����ģʽ 
#define SGD_SM6_CFB			0x80000304       //SM6 �㷨 CFB ����ģʽ 
#define SGD_SM6_OFB			0x80000308       //SM6 �㷨 OFB ����ģʽ 
#define SGD_SM6_MAC			0x80000310       //SM6 �㷨 MAC ���� 
////////////////////////////VENDOR DEFINED/////////////////////////////////////
...
#define ADMIN_TYPE			0				//����Ա PIN ���� 
#define USER_TYPE			1				//�û� PIN ���� 


/* account */
#define SECURE_NEVER_ACCOUNT	0x00		//������ 
#define SECURE_ADM_ACCOUNT		0x01		//����ԱȨ�� 
#define SECURE_USER_ACCOUNT		0x10		//�û�Ȩ�� 
#define SECURE_ANYONE_ACCOUNT	0xFF		//�κ��� 
